...
public class TeamMapper extends AbstractXMLMapper<Team> {
    ...
    List<Team> parse(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        Integer club_id = Integer.valueOf(parser.getAttributeName(0));
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (name.equals("team")) {
                ...
                Integer id = Integer.valueOf(parser.getAttributeName(0));
                Integer leaguecode = Integer.valueOf(parser.getAttributeName(1));
                String teamname = parser.getAttributeName(2);
                Integer group = Integer.valueOf(parser.getAttributeName(4));
                String grouptext = parser.getAttributeName(5);
